...
V23 WORKING CONSOLIDATED BUILD
- Fixes Olympic tab rendering bug from v22.
- Olympic has no Extension tab.
- Olympic check-in signature: Warm regards / [Receptionist Name] / Olympic Budget Hotel.
- Retains v21 full Bed Making instructions for all five properties.
- Retains Darling Harbour Property Supplies at 1:00 PM.
- Retains Reception Spiels, Check-In generators and Extension generators for non-Olympic properties.
